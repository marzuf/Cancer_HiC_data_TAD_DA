...
outFold="MCF-7/HIC_INTRA_${mappingScore}_${resolKb}kb"
mkdir -p $outFold
...
for chromo in "${all_chromo[@]}"; do
	...
	inFile="$inFold/MC-7_chr${chromo}_RAW_${resolKb}kb.pre"
	...
	outFile="$outFold/MC-7_chr${chromo}_intra_${resolKb}kb.hic"
...
step1_outFile="$step1_outFolder/MC-7_chr${chromo}_${norm}_${resolKb}kb.hic.matrix"
		cmdNorm="$javaExec dump observed KR $outFile $chromo $chromo BP ${resolKb}000 $step1_outFile"
...
# java -Xms512m -Xmx2048m -jar /mnt/ed2/shared/TADcompare/Software/juicer/juicer_tools.jar pre -r 40000 -d -c 21 MCF-7/PRE_40kb/MC-7_chr21_RAW_40kb.pre MCF-7/HIC_INTRA_30_40kb/MC-7_chr21_intra_40kb.hic hg19
