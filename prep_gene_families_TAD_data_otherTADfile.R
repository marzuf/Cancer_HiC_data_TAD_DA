...
# Rscript prep_gene_families_TAD_data_otherTADfile.R MCF-7_40kb
...
ensembl_geneFamilyDT <- ensembl_geneFamilyDT[ensembl_geneFamilyDT$Chromosome.scaffold.name %in% tadDT$chromo,]
ensembl_geneFamilyDT <- unique(ensembl_geneFamilyDT)
stopifnot(nrow(ensembl_geneFamilyDT) > 0)
