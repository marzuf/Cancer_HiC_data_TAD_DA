    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAcoad_msi_mss/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAcoad_msi_mss/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAcoad_msi_mss/msi_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAcoad_msi_mss/mss_ID.Rdata"
...
# > file edited: Sat, 19 Jan 2019 16:28:31 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105318_DLD1_40kb/TCGAcoad_msi_mss"

# OVERWRITE THE DEFAULT SETTINGS FOR INPUT FILES - use TADs from the current Hi-C dataset 
TADpos_file <- paste0(setDir, "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/GSE105318_DLD1_40kb/genes2tad/all_assigned_regions.txt")
#chr1    chr1_TAD1       750001  1300000
#chr1    chr1_TAD2       2750001 3650000
#chr1    chr1_TAD3       3650001 4150000

gene2tadDT_file <- paste0(setDir, "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/GSE105318_DLD1_40kb/genes2tad/all_genes_positions.txt")
