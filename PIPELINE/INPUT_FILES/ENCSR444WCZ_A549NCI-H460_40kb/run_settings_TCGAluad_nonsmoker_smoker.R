    ...
    # > file written: Sat, 08 Dec 2018 03:19:29 +0100 

    # in this file, settings that are specific for a run on a dataset

    # gives path to output folder
    pipOutFold <- "OUTPUT_FOLDER/TCGAluad_nonsmoker_smoker"
    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAluad_nonsmoker_smoker/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAluad_nonsmoker_smoker/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAluad_nonsmoker_smoker/nonsmoker_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAluad_nonsmoker_smoker/smoker_ID.Rdata"
...
# > file edited: Mon, 04 Mar 2019 11:50:54 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR444WCZ_A549NCI-H460_40kb/TCGAluad_nonsmoker_smoker"

# OVERWRITE THE DEFAULT SETTINGS FOR INPUT FILES - use TADs from the current Hi-C dataset 
TADpos_file <- paste0(setDir, "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/ENCSR444WCZ_A549NCI-H460_40kb/genes2tad/all_assigned_regions.txt")
#chr1    chr1_TAD1       750001  1300000
#chr1    chr1_TAD2       2750001 3650000
#chr1    chr1_TAD3       3650001 4150000

gene2tadDT_file <- paste0(setDir, "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/ENCSR444WCZ_A549NCI-H460_40kb/genes2tad/all_genes_positions.txt")
