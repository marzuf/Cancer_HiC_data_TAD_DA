    ...
    # > file written: Sat, 08 Dec 2018 23:49:14 +0100 

    # in this file, settings that are specific for a run on a dataset

    # gives path to output folder
    pipOutFold <- "OUTPUT_FOLDER/TCGAluad_mutKRAS_mutEGFR"
    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAluad_mutKRAS_mutEGFR/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAluad_mutKRAS_mutEGFR/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAluad_mutKRAS_mutEGFR/mutKRAS_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAluad_mutKRAS_mutEGFR/mutEGFR_ID.Rdata"
...
# > file edited: Mon, 04 Mar 2019 11:50:52 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR444WCZ_A549NCI-H460_40kb/TCGAluad_mutKRAS_mutEGFR"
