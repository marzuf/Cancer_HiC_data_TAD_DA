    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAlusc_norm_lusc/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAlusc_norm_lusc/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAlusc_norm_lusc/norm_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAlusc_norm_lusc/lusc_ID.Rdata"
...
# > file edited: Wed, 16 Jan 2019 09:37:33 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR444WCZ_A549NCI-H460_40kb/TCGAlusc_norm_lusc"
