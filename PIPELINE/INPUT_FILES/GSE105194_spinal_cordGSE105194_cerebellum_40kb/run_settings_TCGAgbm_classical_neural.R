    ...
    # > file written: Fri, 07 Dec 2018 22:37:22 +0100 

    # in this file, settings that are specific for a run on a dataset

    # gives path to output folder
    pipOutFold <- "OUTPUT_FOLDER/TCGAgbm_classical_neural"
    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAgbm_classical_neural/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAgbm_classical_neural/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAgbm_classical_neural/classical_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAgbm_classical_neural/neural_ID.Rdata"
...
# > file edited: Mon, 21 Jan 2019 16:28:29 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105194_spinal_cordGSE105194_cerebellum_40kb/TCGAgbm_classical_neural"
