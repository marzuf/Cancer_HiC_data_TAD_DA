    ...
    # > file written: Fri, 07 Dec 2018 17:43:13 +0100 

    # in this file, settings that are specific for a run on a dataset

    # gives path to output folder
    pipOutFold <- "OUTPUT_FOLDER/TCGAlgg_IDHwt_IDHmutnc"
    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAlgg_IDHwt_IDHmutnc/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAlgg_IDHwt_IDHmutnc/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAlgg_IDHwt_IDHmutnc/IDHwt_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAlgg_IDHwt_IDHmutnc/IDHmutnc_ID.Rdata"
...
# > file edited: Mon, 21 Jan 2019 16:28:57 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105194_spinal_cordGSE105194_cerebellum_40kb/TCGAlgg_IDHwt_IDHmutnc"
