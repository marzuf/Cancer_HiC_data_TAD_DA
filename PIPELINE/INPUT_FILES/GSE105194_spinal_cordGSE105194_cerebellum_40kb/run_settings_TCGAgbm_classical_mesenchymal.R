    ...
    # > file written: Sat, 08 Dec 2018 01:45:58 +0100 

    # in this file, settings that are specific for a run on a dataset

    # gives path to output folder
    pipOutFold <- "OUTPUT_FOLDER/TCGAgbm_classical_mesenchymal"
    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAgbm_classical_mesenchymal/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAgbm_classical_mesenchymal/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAgbm_classical_mesenchymal/classical_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAgbm_classical_mesenchymal/mesenchymal_ID.Rdata"
...
# > file edited: Mon, 04 Mar 2019 11:51:50 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105194_spinal_cordGSE105194_cerebellum_40kb/TCGAgbm_classical_mesenchymal"

# OVERWRITE THE DEFAULT SETTINGS FOR INPUT FILES - use TADs from the current Hi-C dataset 
TADpos_file <- paste0(setDir, "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/GSE105194_spinal_cordGSE105194_cerebellum_40kb/genes2tad/all_assigned_regions.txt")
#chr1    chr1_TAD1       750001  1300000
#chr1    chr1_TAD2       2750001 3650000
#chr1    chr1_TAD3       3650001 4150000

gene2tadDT_file <- paste0(setDir, "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/GSE105194_spinal_cordGSE105194_cerebellum_40kb/genes2tad/all_genes_positions.txt")
