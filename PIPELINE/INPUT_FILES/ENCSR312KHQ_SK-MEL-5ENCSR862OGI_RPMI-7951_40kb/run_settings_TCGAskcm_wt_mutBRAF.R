    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAskcm_wt_mutBRAF/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAskcm_wt_mutBRAF/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAskcm_wt_mutBRAF/wt_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAskcm_wt_mutBRAF/mutBRAF_ID.Rdata"
...
# > file edited: Mon, 04 Mar 2019 17:39:48 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR312KHQ_SK-MEL-5ENCSR862OGI_RPMI-7951_40kb/TCGAskcm_wt_mutBRAF"
