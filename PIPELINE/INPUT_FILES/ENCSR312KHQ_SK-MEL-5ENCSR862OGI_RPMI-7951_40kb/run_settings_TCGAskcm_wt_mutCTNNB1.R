    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAskcm_wt_mutCTNNB1/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAskcm_wt_mutCTNNB1/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAskcm_wt_mutCTNNB1/wt_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAskcm_wt_mutCTNNB1/mutCTNNB1_ID.Rdata"
...
# > file edited: Mon, 04 Mar 2019 17:39:50 +0100 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR312KHQ_SK-MEL-5ENCSR862OGI_RPMI-7951_40kb/TCGAskcm_wt_mutCTNNB1"

# OVERWRITE THE DEFAULT SETTINGS FOR INPUT FILES - use TADs from the current Hi-C dataset 
TADpos_file <- paste0(setDir, "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/ENCSR312KHQ_SK-MEL-5ENCSR862OGI_RPMI-7951_40kb/genes2tad/all_assigned_regions.txt")
#chr1    chr1_TAD1       750001  1300000
#chr1    chr1_TAD2       2750001 3650000
#chr1    chr1_TAD3       3650001 4150000

gene2tadDT_file <- paste0(setDir, "/mnt/etemp/marie/Cancer_HiC_data_TAD_DA/ENCSR312KHQ_SK-MEL-5ENCSR862OGI_RPMI-7951_40kb/genes2tad/all_genes_positions.txt")
