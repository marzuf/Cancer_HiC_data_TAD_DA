...
# Rscript intersect_topTADs_acrossDS.R 1
...
# }
### CHANGED 04.03.2019 TO INVESTIGATE CONSERVED TADs
if(topThresh == 1) {
  warning("topThresh == 1 is ambiguous; will be considered as a pval thresh not nTop !\n")
}
