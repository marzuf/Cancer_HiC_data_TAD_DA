...
# Rscript plot_lolliTAD.R TCGAcrc_msi_mss ../TAD_DE_pipeline_v2_TopDom/PLOT_LOLLITAD/TCGAcrc_msi_mss chr6_TAD52 chr6_TAD58
...
# curr_outFold <- paste0("PLOT_LOLLITAD_", my_dataset)
curr_outFold <- outFold
...
outFile <- paste0(curr_outFold, "/", my_dataset, "_", paste0(all_TADs, collapse = "_"), ".", plotType)
