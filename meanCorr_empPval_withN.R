...
# Rscript meanCorr_empPval_withN.R
...
script_name <- "meanCorr_empPval_withN.R"
cat("... start ", script_name, "\n")
startTime <- Sys.time()


outFolder <- paste0("MEANCORR_EMPPVAL_WITHN")
