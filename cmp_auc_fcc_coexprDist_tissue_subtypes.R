...
cat("> START: cmp_auc_fcc_coexprDist_tissue_subtypes.R\n")
# Rscript cmp_auc_fcc_coexprDist_tissue_subtypes.R
...
outFold <- file.path("CMP_AUC_FCC_COEXPRDIST_TISSUE_SUBTYPES")
...
outFile <- file.path(outFold, "all_auc_DT.Rdata")
save(all_auc_DT, file=outFile)
cat(paste0("... written: ", outFile, "\n"))

load("CMP_AUC_FCC_COEXPRDIST_TISSUE_SUBTYPES/all_auc_DT.Rdata")
# dataset   aucFCC aucCoexprDist aucCoexprDistSameFam
# 1      TCGAkich_norm_kich 1.474694      1.071116            1.0790749
# 2      TCGAkich_norm_kich 1.453519      1.093380            0.9698212
# 3 TCGAskcm_lowInf_highInf 1.266463      1.175402            1.1387169
...
all_comps <- list(
  ...
  c("aucCoexprDist", "aucCoexprDistSameFam")
