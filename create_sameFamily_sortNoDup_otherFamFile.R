startTime <- Sys.time()
cat(paste0("> Rscript create_sameFamily_sortNoDup_otherFamFile.R\n"))
...
# Rscript create_sameFamily_sortNoDup_otherFamFile.R MCF-7_40kb
...
outFold <- file.path("CREATE_SAME_FAMILY_SORTNODUP", curr_ds)
...
inFoldFamily <- file.path("PREP_GENE_FAMILIES_TAD_DATA", curr_ds)
